<!--- 
    Code Sample: variable-naming-best-practices
    Module: 10, Lesson: 5
...
<head>
    ...
    <title>Code Sample - variable-naming-best-practices</title>
    <style>
        body { 
...
<body>
    <div class="container">
        <h1>Code Sample: variable-naming-best-practices</h1>
        
        <div class="info">
            <strong>Module:</strong> 10 | <strong>Lesson:</strong> 5<br>
        ...
        <div class="code-block">
            ...
            <cfoutput>
                <p>Placeholder code sample for Module 10, Lesson 5</p>
