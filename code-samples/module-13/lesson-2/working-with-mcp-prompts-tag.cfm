<!--- Tag Syntax: Working with MCP Prompts (CF 2025 Feature Update+) --->
<!--- 
...
--->
<cfset prompts = mcpClient.listPrompts()>

<cfset promptDef = mcpClient.getPrompt({
    name: "explain-code",
    arguments: {
